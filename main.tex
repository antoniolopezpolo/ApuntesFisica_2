...
%%
% Book metadata
\title{F\'\i{}sica II\thanks{A Julio Aguado por su apoyo e inspiraci\'on}}
\author[Antonio Lopez Polo]{Antonio L\'opez Polo}
\publisher{Salesianos|Zaragoza}
...
\openepigraph{%
%Sagredo: Deteneos un momento, se\~nor Salviati, porque me parece advertir que no vais directamente al meollo de la cuesti\'on que plante\'ais.
}{%Galileo Galilei%, {\itshape Di\'alogo sobrelos dos m\'aximos sistemas del mundo ptolem\'aico y copernicano}
}
...
\nohyphenation
Este manual cubre los contenidos descritos para la asignatura de F\'\i{}sica de segundo curso de bachillerato.
\end{doublespace}
\vfill
\vfill
...
\chapter{Interacci\'on gravitatoria}
\label{ch:gravedad}
\include{InteraccionGravitatoria}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Interacci\'on electromagn\'etica}
\label{ch:electromagnetismo}

\section{Campo el\'ectrico}

\section{Campo e Intensidad del campo}

\section{Potencial el\'ectrico}

\section{Flujo el\'ectrico y Ley de Gauss. Aplicaciones}

\section{Campo magn\'etico}

\section{Efecto de los campos magn\'eticos sobre las cargas en movimiento}

\section{El campo magn\'etico como campo no conservativo}

\section{Campos creados por diferentes elementos de corriente}

\section{Ley de Amp\`ere}

\section{Inducci\'on electrogmagn\'etica}

\section{Flujo magn\'etico}

\section{Leyes de Faraday-Henry y Lenz. Fuerza electromotriz}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Ondas}
\label{ch:ondas}

\section{Clasificaci\'on y magnitudes que las caracterizan}

\section{Ecuaci\'on de las ondas arm\'onicas}

\section{Energ\'\i{}a e intensidad}

\section{Ondas transversales en una cuerda}

\section{Fen\'omenos ondulatorios: Interferencia y difracci\'on. Reflexi\'on y refracci\'on}

\section{Efecto Doppler}

\section{Ondas longitudinales. El sonido}

\section{Energ\'\i{}a e intensidad de las ondas sonoras. Contaminaci\'on ac\'ustica}

\section{Aplicaciones tecnol\'ogicas del sonido}

\section{Ondas electromagn\'eticas}

\section{Naturaleza y propiedades de las ondas electromagn\'eticas}

\section{El espectro electromagn\'etico}

\section{El color}

\section{Transmisi\'on de la comunicaci\'on}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{\'Optica geom\'etrica}
\label{ch:opticageometrica}

\section{Leyes de la \'optica geom\'etrica}

\section{Sistemas ópticos: lentes y espejos}

\section{El ojo humano. Defectos visuales}

\section{Aplicaciones tecnol\'ogicas: instrumentos \'opticos y la fibra \'optica}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{F\'\i{}sica del siglo XX}
\label{ch:fisicasigloxx}

\section{Introducci\'on a la Teor\'\i{}a especial de la relatividad}

\section{Energ\'\i{}a relativista. Energ\'\i{}a total y energ\'\i{}a en reposo}

\section{F\'\i{}sica cu\'antica}

\section{Insuficiencia de la f\'\i{}sica cl\'asica}

\section{Or\'\i{}genes de la f\'\i{}sica cu\'antica. Problemas precursores}

\section{Interpretaci\'on probabil\'\i{}tica de la f\'\i{}sica cu\'antica}

\section{Aplicaciones de la f\'\i{}sica cu\'antica. El l\'aser}

\section{F\'\i{}sica nuclear}

\section{La radiactividad. Tipos}

\section{El n\'ucleo at\'omico. Leyes de la desintegraci\'on radiactiva}

\section{Fusi\'on y fisi\'on nucleares}

\section{Interacciones fundamentales de la naturaleza y part\'\i{}culas elementales}

\section{Las cuatro interacciones fundamentales de la naturaleza: gravitatoria, electromagn\'etica, nuclear fuerte y nuclear d\'ebil}

\section{Part\'\i{}culas fundamentales constitutivas del \'atomo: electrones y quarks}

\section{Historia y composici\'on del universo}

\section{Fronteras de la F\'\i{}sica}
